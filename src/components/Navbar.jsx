    ...
    <header className="fixed top-0 left-0 w-full bg-[#A1410F] shadow-md z-50 px-4 md:px-16 py-4">
      <div className="flex items-center justify-between">
        ...
        <nav className="hidden md:flex space-x-8 text-white text-lg font-light">
          <a href="/" className="hover:text-gray-300" data-aos="fade-down">Home</a>
          ...
          >
            ...
            {showDropdown && (
              <div className="absolute top-full left-0 w-56 mt-0 bg-[#A1410F] rounded-xl shadow-lg">
          ...
          <a href="/about" className="hover:text-gray-300" data-aos="fade-down">About</a>
          <a href="/contact" className="hover:text-gray-300" data-aos="fade-down">Contact</a>
        </nav>
